...
const SuccessCard = () => {
    ...
    return (
        <div className=" rounded-3xl shadow-2xl bg-White h-full w-full sm:h-[50%] sm:w-[50vh] p-10">
            ...
            <h1 className=" text-[6.2vh] font-Roboto font-semibold tracking-tight leading-none mb-4 mt-6">Thanks for subscribing!</h1>
            <p className=" font-Roboto text-[2.2vh] sm:text-[1.6vh] mb-1 w-full ">A confirmation email has been sent to <span className=" font-semibold">{email}</span>. Please open it and click the button inside to confirm your subscription</p>
